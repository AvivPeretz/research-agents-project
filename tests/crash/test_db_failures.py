...
class TestDatabaseFailures:
    ...
    def test_get_project_state_on_corrupt_db_returns_none(self, db_in_memory):
        ...
        with patch.object(db_in_memory, "conn") as mock_conn:
            mock_conn.cursor.side_effect = sqlite3.Error("Database corrupted")
    ...
    def test_add_progress_snapshot_on_db_error_does_not_crash(self, db_in_memory):
        ...
        with patch.object(db_in_memory, "conn") as mock_conn:
            ...
            try:
                db_in_memory.add_progress_snapshot("Project", had_changes=True, delta="content")
            except sqlite3.Error:
                pass
